...
void calibNai(){
	...
	//drawBar(0,0,0.075,-2); // draw bar side + barId
	//drawBar(0,1,0.0475,0); // draw bar side + barId
	//drawBar(0,2,0.056,8); // draw bar side + barId
	//drawBar(0,3,0.039,6.5); // draw bar side + barId
	//drawBar(0,4,0.058,4); // draw bar side + barId
	//drawBar(0,5,0.058,4.5); // draw bar side + barId
	//drawBar(0,6,0.08,3); // draw bar side + barId
	//
	//drawBar(1,0,0.078,5); // draw bar side + barId
	//drawBar(1,1,0.09,7); // draw bar side + barId
	//drawBar(1,2,0.085,6.5); // draw bar side + barId
	//drawBar(1,3,0.045,6.5); // draw bar side + barId
	//drawBar(1,4,0.110,8.5); // draw bar side + barId
	//drawBar(1,5,0.175,8); // draw bar side + barId
	//drawBar(1,6,0.073,8); // draw bar side + barId
	...
	drawBar(1,-1,0.004700,0); // draw bar side + barId
}
