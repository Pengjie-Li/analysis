class ReadFile{
   ...
   Double_t        teleAngle_rand;
   Double_t        espriAngle_rand;
		Int_t           hodNHit;
		Int_t           hodID[40];
		Int_t           hodTRaw[2][40];
		Int_t           hodQRaw[2][40];
		...
		void setReadBranch(){
			...
			inputTree->SetBranchAddress("teleAngle_rand",&teleAngle_rand);
			inputTree->SetBranchAddress("espriAngle_rand",&espriAngle_rand);
