...
class Fdc0Event{
	private:
		...
		void setAngle(double rotateAng,double &angle,double &phi,double &x,double &y){
	...
	public:
		...
		void setEvent(){
			...
			for (int i = 0; i < 4; ++i) {
				setAngle(0.6*(i+1),fdc0AngleS[0][i],fdc0PhiS[0][i],fdc0X[0][i],fdc0Y[0][i]);
				setAngle(-0.6*(i+1),fdc0AngleS[1][i],fdc0PhiS[1][i],fdc0X[1][i],fdc0Y[1][i]);
			}

			setAngle(1.1,fdc0AngleS[0][4],fdc0PhiS[0][4],fdc0X[0][4],fdc0Y[0][4]);
			setAngle(1.3,fdc0AngleS[0][5],fdc0PhiS[0][5],fdc0X[0][5],fdc0Y[0][5]);
			setAngle(1.4,fdc0AngleS[0][6],fdc0PhiS[0][6],fdc0X[0][6],fdc0Y[0][6]);

			setAngle(-1.1,fdc0AngleS[1][4],fdc0PhiS[1][4],fdc0X[1][4],fdc0Y[1][4]);
			setAngle(-1.3,fdc0AngleS[1][5],fdc0PhiS[1][5],fdc0X[1][5],fdc0Y[1][5]);
			setAngle(-1.4,fdc0AngleS[1][6],fdc0PhiS[1][6],fdc0X[1][6],fdc0Y[1][6]);
		...
		void setOutputBranch(TTree *tree){
			...
			tree->Branch("fdc0X",fdc0X,"fdc0X[2][7]/D");
			tree->Branch("fdc0Y",fdc0Y,"fdc0Y[2][7]/D");
