...
class CheckEx{
	...
	public:
		...
		void setAlias(){
			...
			tree->SetAlias("MassHe3","3.014932166*1");
			tree->SetAlias("MassHe4","4.001506105*1");
			tree->SetAlias("MassHe6","6.017788744*1");
			tree->SetAlias("MassHe7","7.02645366*1");
			tree->SetAlias("MassHe8","8.032837245*1");
			tree->SetAlias("MassHe9","9.041502161*1");
			tree->SetAlias("MassHe10","10.050167077*1");
			tree->SetAlias("MassHe11","11.05883199*1");
			//tree->SetAlias("MassHe10","10.05171959*1");



		//	tree->SetAlias("MassBe","MassBe10*1");
		//	tree->SetAlias("residueRestMass","MassHe7*AMU");

		//	tree->SetAlias("MassBe","MassBe12*1");
		//	tree->SetAlias("residueRestMass","MassHe9*AMU");

			tree->SetAlias("MassBe","MassBe14*1");
			tree->SetAlias("residueRestMass","MassHe11*AMU");
			...
			tree->SetAlias("alphaMass","MassHe3*AMU");
		...
		void drawEx(){
			tree->Draw("exEnergy>>hEx(200,-60,30)",gate,"colz");
...
void drawExEnergy(){
	...
	//ce->addFile("ppHe3Be10.root");
	//ce->addFile("ppHe3Be12.root");
	ce->addFile("ppHe3Be14.root");
	ce->setAlias();
	ce->loadCut();
	ce->setGate(getGate());
