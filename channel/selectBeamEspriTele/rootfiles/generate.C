#include "/Volumes/LPJ/S12/analysis/DrawTree.h"
#include "/Volumes/LPJ/S12/analysis/DrawCurve.h"
#include "/Volumes/LPJ/S12/analysis/LoadCut.h"
...
void generate(){
		...
		dt->addFile("ppA.root_Be10_test");//Be10
...
//		TString rightBar = "naiQPed[2][3]>0&&naiQPed[3][3]>0&&sqrt(naiQPed[2][3]*naiQPed[3][3])>200";
		...
		TString leftBar02 = "(plasHit == 1&&plasHitSide[0] == 0 &&plasQPed[0]>10&&plasQPed[1]>10&&sqrt(plasQPed[0]*plasQPed[1])>100&&naiQPed[0][2]>10&&naiQPed[1][2]>10&&sqrt(naiQPed[0][2]*naiQPed[1][2])>100 && ProtonBar02)";
		//TString leftBar02 = "(plasHit == 1 &&plasQPed[0]>10&&plasQPed[1]>10&&sqrt(plasQPed[0]*plasQPed[1])>100&&naiQPed[0][2]>10&&naiQPed[1][2]>10&&sqrt(naiQPed[0][2]*naiQPed[1][2])>100 )";
		TString leftBar03 = "(plasHit == 1&&plasHitSide[0] == 0 &&plasQPed[0]>10&&plasQPed[1]>10&&sqrt(plasQPed[0]*plasQPed[1])>100&&naiQPed[0][3]>10&&naiQPed[1][3]>10&&sqrt(naiQPed[0][3]*naiQPed[1][3])>100 && ProtonBar03)";
		//TString leftBar03 = "(plasHit == 1 &&plasQPed[0]>10&&plasQPed[1]>10&&sqrt(plasQPed[0]*plasQPed[1])>100&&naiQPed[0][3]>10&&naiQPed[1][3]>10&&sqrt(naiQPed[0][3]*naiQPed[1][3])>100 && ProtonBar03)";
		TString rightBar12 = "(plasHit == 1&&plasHitSide[0] == 1 &&plasQPed[2]>10&&plasQPed[3]>10&&sqrt(plasQPed[2]*plasQPed[3])>100&&naiQPed[2][2]>10&&naiQPed[3][2]>10&&sqrt(naiQPed[2][2]*naiQPed[3][2])>100 && ProtonBar12)";
		//TString rightBar12 = "(plasHit == 1 &&plasQPed[2]>10&&plasQPed[3]>10&&sqrt(plasQPed[2]*plasQPed[3])>100&&naiQPed[2][2]>10&&naiQPed[3][2]>10&&sqrt(naiQPed[2][2]*naiQPed[3][2])>100 && ProtonBar12)";
		TString rightBar13 = "(plasHit == 1&&plasHitSide[0] == 1 &&plasQPed[2]>10&&plasQPed[3]>10&&sqrt(plasQPed[2]*plasQPed[3])>100&&naiQPed[2][3]>10&&naiQPed[3][3]>10&&sqrt(naiQPed[2][3]*naiQPed[3][3])>100 && ProtonBar13)";
		//TString rightBar13 = "(plasHit == 1 &&plasQPed[2]>10&&plasQPed[3]>10&&sqrt(plasQPed[2]*plasQPed[3])>100&&naiQPed[2][3]>10&&naiQPed[3][3]>10&&sqrt(naiQPed[2][3]*naiQPed[3][3])>100 && ProtonBar13)";
		...
		dt->setGate("Trig_BxESPRIxTEL&&Beam&&"+targetArea+"&&"+leftBar02);
		dt->setName("hRDCL02");
