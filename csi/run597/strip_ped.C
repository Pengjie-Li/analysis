...
void strip_ped()
{
	...
	TString inputname="./rootfiles/run0597_Beamv8.root";
...
void Ped_SiLF()
{
        ...
        cSiLFped->cd();
        hSiLFped->GetYaxis()->SetRangeUser(0,350);
        gPad->SetLogz();
        hSiLFped->Draw("colz");

        TF1* foo = new TF1("foo","gaus",0,350);
...
void Ped_SiRF()
{
        ...
        cSiRFped->cd();
        hSiRFped->GetYaxis()->SetRangeUser(0,300);
        gPad->SetLogz();
        hSiRFped->Draw("colz");
...
void Ped_SiRB()
{
        ...
        cSiRBped->cd();
        hSiRBped->GetYaxis()->SetRangeUser(0,300);
        gPad->SetLogz();
        hSiRBped->Draw("colz");
