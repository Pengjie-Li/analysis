void Fit_SlicesD()
{
	TH2F * h2d = (TH2F*)gDirectory->Get("hHodIdEnergyDownRaw")->Clone("h2d");
	...
	cin >> run;
	fout.open(Form("/media/Projects/RIKEN_Cluster_2018/lipj/exp_201805/anaroot/users/analysis/macros/hod/pedestal/txtfiles/HOD_down_%04d.txt",run));
