...
//     (Tue Jun  4 09:55:02 2019 by ROOT version5.34/20)
//   from TTree tree/Analysed Tree:raw,cal,analysed
//   found on file: run0360_analysed.root
//////////////////////////////////////////////////////////


//Reset ROOT and connect tree file
   gROOT->Reset();
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run0360_analysed.root");
   if (!f) {
      f = new TFile("run0360_analysed.root");
   }
