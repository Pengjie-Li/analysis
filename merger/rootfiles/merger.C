...
//     (Mon Dec  2 15:17:56 2019 by ROOT version5.34/20)
//   from TTree tree/Analysed Tree:raw,cal,analysed
//   found on file: run0310_analysed.root_3
//////////////////////////////////////////////////////////


//Reset ROOT and connect tree file
   gROOT->Reset();
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run0310_analysed.root_3");
   if (!f) {
      f = new TFile("run0310_analysed.root_3");
   }
...
//Declaration of leaves types
   ...
   tree->SetBranchAddress("naiBarMQPed",naiBarMQPed);
   tree->SetBranchAddress("naiBarMQSync",naiBarMQSync);
   tree->SetBranchAddress("naiBarMQCal",naiBarMQCal);
   tree->SetBranchAddress("naiBarMSQCal",naiBarMSQCal);
   ...
   tree->SetBranchAddress("plasBarMQPed",plasBarMQPed);
   tree->SetBranchAddress("plasTCal",plasTCal);
   tree->SetBranchAddress("plasMQ",plasMQ);
   ...
   tree->SetBranchAddress("isEspriLR",&isEspriLR);
   tree->SetBranchAddress("isEspriRdc",&isEspriRdc);
   tree->SetBranchAddress("isEspriPlas",&isEspriPlas);
   tree->SetBranchAddress("naiBarId",&naiBarId);
   tree->SetBranchAddress("naiNHit",&naiNHit);
