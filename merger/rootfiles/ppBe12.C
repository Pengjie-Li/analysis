...
//	tree->Add("run0361_analysed.root");
	...
	gROOT->ProcessLine(".x cutHodBe12.C");
	if(isDrawTOFAng){
		...
		c->cd(5);
		tree->Draw("plasT[0]-F13T:protonTheta>>hB(200,40,80,200,-900,-840)","BeamBe12","colz");
		c->cd(6);
		tree->Draw("plasT[0]-F13T:protonTheta>>hPTB(200,40,80,200,-900,-840)","BeamBe12&&Proton&&"+peak5,"colz");
		c->cd(7);
		tree->Draw("plasT[0]-F13T:protonTheta>>hH(200,40,80,200,-900,-840)","HodBe12","colz");
		c->cd(8);
		tree->Draw("plasT[0]-F13T:protonTheta>>hPTBH(200,40,80,200,-900,-840)","BeamBe12&&Proton&&HodBe12&&"+peak5,"colz");
	...
	if(isDrawEAng){
		...
		c->cd(5);
		tree->Draw("2*naiQ[0]:protonTheta>>hB(200,40,80,200,0,200)","BeamBe12","colz");
		c->cd(6);
		tree->Draw("2*naiQ[0]:protonTheta>>hBPT(200,40,80,200,0,200)","BeamBe12&&Proton&&"+peak5,"colz");
		c->cd(7);
		tree->Draw("2*naiQ[0]:protonTheta>>hH(200,40,80,200,0,200)","HodBe12","colz");
		c->cd(8);
		tree->Draw("2*naiQ[0]:protonTheta>>hBPTH(200,40,80,200,0,200)","BeamBe12&&Proton&&HodBe12&&"+peak5,"colz");
	}
}
