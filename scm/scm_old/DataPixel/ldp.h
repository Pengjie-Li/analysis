...
class LDP
{
	...
	public:
		...
		int left_remove_multihit(vector<double>  fadc,vector<double>  badc,int &fid,int &bid);
		int right_remove_multihit(vector<double>  fadc,vector<double>  badc,int &fid,int &bid);
