...
//	double rbf=-1665.092353;
	...
	TString outputname=Form("run%d_checking_calibration_v4.root",runnum); //Fit paramter whole DSSD 
	...
	for (Long64_t ientry=0; ientry<nentries;ientry++) {
		...
		for(int id=0;id<32;id++)
		{
			...
			//double fscm=0;
			double lfscm=lk[0][id]*lfraw+lb[0][id];
			//double bscm=0;
			double lbscm=lk[1][id]*lbraw+lb[1][id];
			...
			//double fscm=0;
			double rfscm=rk[0][id]*rfraw+rb[0][id];
			//double bscm=0;
			double rbscm=rk[1][id]*rbraw+rb[1][id];
...
void Load(int lr,double k[4][32],double b[4][32],double ek[4][32],double eb[4][32])
{
	ifstream in;
	TString par_name;
//	if(lr==0) par_name="/media/Projects/RIKEN_Cluster_2018/lipj/exp_201805/anaroot/users/analysis/macros/scm/runs/DSSD_SCM_Left_Whole.txt";
//	else  par_name="/media/Projects/RIKEN_Cluster_2018/lipj/exp_201805/anaroot/users/analysis/macros/scm/runs/DSSD_SCM_Right_Whole.txt";

        if(lr==0) par_name="/media/Projects/RIKEN_Cluster_2018/lipj/exp_201805/anaroot/users/analysis/macros/scm/Remove/DSSD_Fit_Left_Whole.txt";
        else  par_name="/media/Projects/RIKEN_Cluster_2018/lipj/exp_201805/anaroot/users/analysis/macros/scm/Remove/DSSD_Fit_Right_Whole.txt";
