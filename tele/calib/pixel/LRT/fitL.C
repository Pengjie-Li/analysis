...
void CsI()
{
	double Energy[2]={311.02,495.02};
	double E[3]; E[0]=0;E[1]=Energy[0];E[2]=Energy[1];

	double ADC[2]={1.34437e+03,1.94408e+03};
	double ADC_Sigma[2]={7.84118e+00,9.00948e+00};
	double ped=8.46332e+01; // 8.45634e+01
...
void DSSD()
{
	...
	double Energy[2]={7036,9803.9};
	double E[3]; E[0]=0;E[1]=Energy[0];E[2]=Energy[1];

	double ADCF[2]={1348,1770};
	double ADCF_Sigma[2]={5.76658e+01,6.30084e+01};
	double pedF=168.183;
	double fadc[3]; fadc[0]=pedF;fadc[1]=ADCF[0];fadc[2]=ADCF[1];


	double ADCB[2]={1194,1582};
	double ADCB_Sigma[2]={5.65184e+01,6.24992e+01};
	double pedB=98.8717;
