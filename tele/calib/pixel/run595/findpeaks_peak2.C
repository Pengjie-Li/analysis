...
{
	TString inputname;
	if(isLR==0) inputname=Form("pixelrootfiles/Lpixel%d_%d_run0%d.root",fid,bid,runnum);
	else inputname=Form("pixelrootfiles/Rpixel%d_%d_run0%d.root",fid,bid,runnum);
